                            ...
                            <div class="col">
                                ...
                                <div class="avatar-group mt-2">
                                    ...
                                    <div class="avatar avatar-xs">
                                        <img src="{{asset('assets1/images/256_joao-silas-636453-unsplash.jpg')}}" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="avatar-group mt-2">
                                    ...
                                    <div class="avatar avatar-xs">
                                        <img src="assets1/images/256_rsz_1andy-lee-642320-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>

                                    <div class="avatar avatar-xs">
                                        <img src="assets1/images/256_michael-dam-258165-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>

                                    <div class="avatar avatar-xs">
                                        <img src="assets1/images/256_luke-porter-261779-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>

                                    <div class="avatar avatar-xs">
                                        <img src="assets1/images/stories/256_rsz_clem-onojeghuo-193397-unsplash.jpg" alt="Avatar" class="avatar-img rounded-circle">
                                    </div>
