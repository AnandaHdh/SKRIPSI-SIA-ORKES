...
<div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page">
	<div class="container-fluid page__container">
		<form method="POST" action="{{ route('alamat.store') }}" autocomplete="off">
			@csrf
			...
			<div class="row no-gutters">
				<div class="col-lg-10 card-form__body card-body">
					<div class="form-group">
						...
						<input style="width: 270px;" name="daerah" type="text" class="form-control" placeholder="Nama" required="">
					</div>
                    <div class="form-group">
						...
						<select name="harga_id" style="width: 270px;" class="form-control">
                            ...
                            <option value={{ $price->id }}>{{ $price->harga }} - {{ $price->waktu }}</option>
                            @endforeach
                        </select>
					</div>
				</div>
