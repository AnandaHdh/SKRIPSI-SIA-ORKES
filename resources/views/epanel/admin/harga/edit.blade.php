...
@include('layouts.partials.header', [
    'judul' => 'Edit Daftar Harga'
])

<div class="mdk-header-layout__content mdk-header-layout__content--fullbleed mdk-header-layout__content--scrollable page">
	<div class="container-fluid page__container">
		<form method="POST" action="{{ route('harga.update', $data->id) }}" autocomplete="off">
			@csrf
			...
			<div class="row no-gutters">
				<div class="col-lg-10 card-form__body card-body">
					<div class="form-group">
						...
						<input style="width: 270px;" name="waktu" type="text" value="{{ $data->waktu }}" class="form-control" placeholder="Nama" required="">
					</div>
                    <div class="form-group">
						<label for="opass">Harga</label>
						<input style="width: 270px;" name="harga" type="text" value="{{ $data->harga }}" class="form-control" placeholder="Nama" required="">
					</div>
				</div>
